...
--transform Similarity[ 0.1 ] \
        --metric Mattes[ ${target},${moving},1,32,None ] \
        --convergence [ 500x500x500x450x150,1e-6,10 ] \
        --shrink-factors 5x5x4x3x2 \
        --smoothing-sigmas 2.5123277660148595x2.0804050381276458x1.6447045940431997x1.2011224087864498x0.735534255037358mm \
--transform Similarity[ 0.1 ] \
        --metric Mattes[ ${target},${moving},1,32,None ] \
        --convergence [ 500x500x500x450x150,1e-6,10 ] \
        --shrink-factors 5x5x4x3x2 \
...
--transform Affine[ 0.1 ] \
        --metric Mattes[ ${target},${moving},1,64,None ] \
        --convergence [ 450x150x50,1e-6,10 ] \
