...
SUBJECTS_DIR="/cluster/osc/data/pilot-oscm/pilot-01/freesurfer"

## Subject specific config
SUBJID=$1
COMBINED_MEMPRAGE="/cluster/osc/data/pilot-oscm/pilot-01/${SUBJID}/anat/${SUBJID}_acq-FOCI520V_preproc-bico_T1w.nii.gz"
